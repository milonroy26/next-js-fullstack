...
const SignUp = () => {
    let fristNameRef, lastNameRef, emailRef, passwordRef  = useRef();

    const handelSubmit = async (e) => {
        e.preventDefault();

        let fristName = fristNameRef.value;
    ...
    return (
        ...
        <section className="py-12 bg-blue-600 h-screen flex justify-center items-center">
            <div className="container px-4 mx-auto">
                ...
                <form onSubmit={handelSubmit} className="mt-12 mb-8 p-8 bg-white rounded">
